...
export const AgentService = {
  ...
  metrics: {
    ...
    responseSerialize: (value: MetricsResponse): Buffer => Buffer.from(MetricsResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): MetricsResponse => MetricsResponse.decode(value),
  },
  getHost: {
    path: "/agent.Agent/GetHost",
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: GetHostRequest): Buffer => Buffer.from(GetHostRequest.encode(value).finish()),
    requestDeserialize: (value: Buffer): GetHostRequest => GetHostRequest.decode(value),
    responseSerialize: (value: GetHostResponse): Buffer => Buffer.from(GetHostResponse.encode(value).finish()),
    responseDeserialize: (value: Buffer): GetHostResponse => GetHostResponse.decode(value),
  },
} as const;
